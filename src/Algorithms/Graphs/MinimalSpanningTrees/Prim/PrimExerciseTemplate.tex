\textbf{\LARGE{\color{tumgadPurple}Prim's Algorithm}}\\
\\
\noindent
...
\begin{minipage}[c]{1.25\textwidth}
    ...
    \end{center}
\end{minipage}
Follow \href{https://github.com/SebastianOner/TUMGAD/src/Algorithms/Graphs/MinimalSpanningTrees/Prim/Prim.md}
{\underline{Prim's algorithm}} to produce a minimal spanning tree originating at node A
