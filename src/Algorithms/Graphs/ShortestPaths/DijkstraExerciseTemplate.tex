...
\begin{center}
    \begin{tikzpicture}[
        ...
        \node[state, draw=none] (45) [right of=44] {%45
        };
        \node[state, fill=tumgadBlue] (46) [right of=45] {%46
        };

        %$CONNECTIONS$
    \end{tikzpicture}
\end{center}
a) Follow the algorithm of Dijkstra as covered in the lecture and find the shortest path from node $A$ to node $MAXCHAR$.\\
